  ...
  <div class="flex flex-col min-h-screen">
    ...
    >
      ...
      <div class="relative z-10 max-w-3xl mx-auto">
        <h1 class="text-5xl font-bold text-[#2C702C] mb-4 drop-shadow-lg">
          {{ $t("common.aboutUs") }}
        </h1>
    ...
    <section class="w-full mx-auto bg-[#BFD6BF] shadow p-8">
      ...
      <section class="max-w-6xl mx-auto my-8 bg-white rounded-2xl shadow p-8" id="terms">
        ...
        <p class="text-gray-600 mb-4 flex items-start">
          <span class="text-green-600 mr-2 text-xl"
        ...
        <div class="grid md:grid-cols-2 gap-6">
          ...
          <div>
            ...
            <ul class="space-y-2 text-gray-700">
              ...
              <li><font-awesome-icon :icon="['fas', 'envelope']" />karakib@gmail.com</li>
            </ul>
          </div>
  ...
  computed: {
    ...
    formattedContactPhone() {
      ...
      const locale =
        (this.$i18n &&
          (this.$i18n.locale ||
            (this.$i18n.global && this.$i18n.global.locale && this.$i18n.global.locale.value))) ||
        "";
