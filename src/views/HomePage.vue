<template>
  ...
  <div>
    <div
      ...
      style="
        background-image: url('/images/delivery-service-truck-isolated.png');
      "
    >
      ...
      <div class="hero-content text-center items-start justify-start pt-14">
        <div class="max-w-3xl">
          ...
          <p class="py-6 text-md font-medium text-[#439a43]">
            Karakib makes it easy to collect waste, earn points, and turn your
            actions into real rewards — because sustainability should pay off.
          </p>
          <button
    ...
    <section class="px-16 py-14 bg-[#E9EBF8]">
      <p class="text-4xl text-[#2C702C] font-semibold text-center pb-14">
        How it works
      </p>
      <div class="flex flex-wrap gap-4 justify-around">
        ...
        <div class="card bg-base-100 shadow-sm w-[280px] rounded-[50px]">
          ...
          <div class="card-body text-center">
            ...
            <p>
              Get rewarded for your effort with points and exclusive benefits.
            </p>
          </div>
        </div>
      </div>
    ...
    <section class="bg-white px-16 py-16 relative">
      <p class="text-4xl text-[#2C702C] font-semibold text-center">
        Discover Waste Types
      </p>
      ...
      <div class="relative max-w-6xl mx-auto flex items-center justify-center">
        ...
        >
          ...
          >
            ...
            />
            <p class="mt-4 text-2xl font-semibold text-[#2C702C]">
              {{ item.name }}
            </p>
          </div>
        </div>
    ...
    <div class="hero py-14 bg-[#BFD6BF] min-h-[35vh]">
      <div class="hero-content text-center">
        <div class="">
          <h1 class="text-4xl text-[#2C702C] font-semibold">
    ...
    <section class="bg-[#E9EBF8] px-16 py-16 relative">
      ...
      <p class="text-2xl text-[#163816] text-center pt-5 pb-10 font-normal">
        Convert your recycling points into donations for charitable
        organizations
      </p>
    </section>
  </div>
...
export default {
  ...
  Toastify({
    text: `${item.name} added to cart 🛍️`,
    duration: 3000,
    gravity: "top", // top or bottom
    position: "right", // left, center, or right
    backgroundColor: "#2C702C",
    stopOnFocus: true,
    style: {
      borderRadius: "8px",
      fontSize: "14px",
