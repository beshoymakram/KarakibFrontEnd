      ...
      <div class="px-6 py-8 lg:py-12 bg-[#F6F7FB] rounded-lg shadow-sm">
          ...
          <div>
            ...
            <div v-if="productColors.length > 0" class="mb-4">
              ...
              <div class="flex gap-3">
                <button v-for="color in productColors" :key="color.value" @click="selectedColor = color.value" :class="[
        ...
        <div class="px-8">
          ...
          <div class="space-y-6 px-4">
            <div v-for="review in displayedReviews" :key="review.id" class="bg-white rounded-xl p-6 shadow-sm">
              <div class="flex items-start gap-4">
                ...
                <div class="flex-1">
                  ...
                  <p class="text-gray-600 leading-relaxed" :class="expandedReviews[review.id] ? '' : 'line-clamp-2'">
                    {{ review.comment }}
                  </p>
