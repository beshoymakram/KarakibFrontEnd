  ...
  <div class="bg-[#BFD6BF] min-h-screen py-8 px-4">
    <div class="w-full max-w-6xl mx-auto">
      ...
      >
        ...
        >
          <img
            class="w-full max-w-xs lg:max-w-md mx-auto mb-6"
          ...
          <p class="font-semibold text-base lg:text-xl px-4">
            Every small act of recycling creates a cleaner tomorrow
          </p>
        </div>
        ...
        >
          <div class="w-full max-w-md" v-if="!authStore.isAuthenticated">
            <h1
              class="font-extrabold text-2xl lg:text-3xl text-main text-shadow-lg text-center mb-8"
            >
              Login
            </h1>
  ...
  methods: {
    async handleLogin() {
      try {
        ...
        // add (error) to catch when use(error)
