              ...
              <div class="form-group mb-4 flex flex-col w-full">
                ...
                <div class="relative">
                  ...
                  <button 
                    ...
                    <svg v-if="showCode" xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  methods: {
    ...
    async handleVerify() {
      ...
      try {
        ...
        console.log('Verifying code:', this.verificationCode, 'for email:', this.email);
