<template>
  <div class="bg-myprofile min-h-screen py-8 px-4" :dir="$i18n.locale === 'ar' ? 'rtl' : 'ltr'">
          ...
          <div class="w-full max-w-md">
            ...
            <form @submit.prevent="handleVerify" class="w-full flex flex-col">
              <div class="form-group mb-4 flex flex-col w-full">
                ...
                <div class="relative">
                  <input v-model="otp" id="code" :type="showCode ? 'text' : 'password'"
                    :placeholder="$t('common.enterCode')" @input="clearError" :class="[
                  ...
                  <button type="button" @click="toggleCodeVisibility" :class="[
    ...
    <transition name="fade">
      <div v-if="showResendPopup" class="popup-overlay">
        <div class="popup-box">
          <div class="icon">✅</div>
  ...
  methods: {
    ...
    async handleResend() {
      ...
      try {
        ...
        resetPasswordService.resendCode({ email: resetEmail });
        this.otp = '';
        this.errorMessage = '';
