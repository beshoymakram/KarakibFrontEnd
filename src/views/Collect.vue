<template>
  <div class="checkout-page bg-secondary min-h-screen  py-6 sm:py-8 md:py-10 lg:py-12">
    <div class="container mx-auto px-4 max-w-6xl">
      <h1 class="text-3xl font-bold text-primary pt-4 sm:pt-8 md:pt-10 lg:pt-12 mb-8">{{ $t('common.checkoutRequests') }}</h1>
