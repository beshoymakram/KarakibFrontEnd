    ...
    <div v-if="showCompleteModal"
      ...
      <div class="relative p-4 w-full max-w-2xl" @click.stop>
        <div class="relative bg-white rounded-lg shadow">
          ...
          <!-- Body -->
          <form @submit.prevent="confirmCompleteWithdraw" class="p-4 md:p-5">
            <div class="grid gap-4 mb-4 grid-cols-2">
              <!-- Proof -->
              <div class="col-span-2">
                <label for="proof" class="block mb-2 text-sm font-medium text-gray-900 ">
                  {{ $t('common.proof') }}
                </label>
                <input type="file" id="proof" @change="handleProofUpload" accept="proof/*"
  ...
  methods: {
    ...
    async confirmCompleteWithdraw() {
      try {
        ...
        const response = await withdrawalsService.completeWithdraw(this.selectedWithdraw, formData);
        nextTick(() => {
