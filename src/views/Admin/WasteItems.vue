      ...
      <div class="relative p-4 w-full max-w-2xl" @click.stop>
        <div class="relative bg-white rounded-lg shadow ">
          ...
          <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600">
            <h3 class="text-xl font-semibold text-[#2C702C]">Create Item</h3>
          ...
          <form @submit.prevent="confirmCreate" class="p-4 md:p-5 space-y-4">
            ...
            <div class="grid grid-cols-3 gap-4">
              ...
              <div>
                <label for="points_per_unit" class="block mb-2 text-sm font-medium text-gray-900">
                  Points per unit
                </label>
    ...
    <div v-if="showEditModal"
      ...
      <div class="relative p-4 w-full max-w-2xl" @click.stop>
        <div class="relative bg-white rounded-lg shadow ">
          <!-- Header -->
          <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600">
            <h3 class="text-xl font-semibold text-[#2C702C]">Edit Item</h3>
          ...
          <form @submit.prevent="confirmEdit" class="p-4 md:p-5 space-y-4">
            ...
            <div class="grid grid-cols-3 gap-4">
              ...
              <div>
                <label for="edit-unit" class="block mb-2 text-sm font-medium text-gray-900">Unit</label>
              ...
              <div>
                <label for="edit-points" class="block mb-2 text-sm font-medium text-gray-900">
                  Points per unit
                </label>
            ...
            <!-- Image (full width) -->
            <div>
              <label for="edit-image" class="block mb-2 text-sm font-medium text-gray-900">Change
