        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
          ...
          <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600">
            <h3 class="text-xl font-semibold text-[#2C702C] dark:text-white">
              {{ $t('common.orderDetails') }} | {{ details.donation_number }}
            </h3>
          ...
          <div class="p-4 md:p-5">
            <div class="grid gap-4 mb-4 sm:grid-cols-2">
              ...
              <div>
                <h4 class="text-sm font-medium text-gray-500 dark:text-gray-300">{{ $t('common.amount') }}</h4>
                <p class="mt-1 text-base font-semibold text-[#2C702C] dark:text-white">
                  {{ details.amount }} {{ $t('common.currency') }}
                </p>
              </div>
            </div>
...
export default {
  ...
  methods: {
    openCancelModal(donation) {
      this.selectedDonation = donation.id;
      this.showCancelModal = true;
    },

    openCompleteModal(donation) {
      this.selectedDonation = donation.id;
