...
const routes = [
...

  {
    ...
    children: [
      ...
      { path: 'waste-types', name: 'AdminWasteTypes', component: WasteTypes },
      { path: 'waste-items', name: 'AdminWasteItems', component: WasteItems },
      { path: 'products', name: 'AdminProducts', component: Products },
      { path: 'products-categories', name: 'AdminProductsCategories', component: ProductsCategories },
    ],
  },
